...
//	);
	...
	public String getUprofilimg() {
		return uprofilimg;
	}
	public void setUprofilimg(String uprofilimg) {
		this.uprofilimg = uprofilimg;
	}
	public String getUadminyn() {
		return uadminyn;
	}
	public void setUadminyn(String uadminyn) {
		this.uadminyn = uadminyn;
	}
	// Getter/Setter
